package com.hisabnikash.erp.enterprisestructure.tenantprofile.api;

import com.hisabnikash.erp.enterprisestructure.common.response.ApiResponse;
import com.hisabnikash.erp.enterprisestructure.tenantprofile.application.TenantProfileService;
...
public class TenantProfileController {
    ...
    public ApiResponse<TenantProfileResponse> create(@Valid @RequestBody CreateTenantProfileRequest request) {
        return ApiResponse.success(service.create(request), "Tenant profile created");
    }
    ...
    public ApiResponse<TenantProfileResponse> update(@PathVariable UUID id,
        ...
        return ApiResponse.success(service.update(id, request), "Tenant profile updated");
    }
}
