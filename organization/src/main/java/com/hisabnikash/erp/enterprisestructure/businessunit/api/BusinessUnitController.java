package com.hisabnikash.erp.enterprisestructure.businessunit.api;

import com.hisabnikash.erp.enterprisestructure.businessunit.application.BusinessUnitService;
...
public class BusinessUnitController {
    ...
    public ApiResponse<BusinessUnitResponse> create(@Valid @RequestBody CreateBusinessUnitRequest request) {
        return ApiResponse.success(service.create(request), "Business unit created");
    }
    ...
    public ApiResponse<BusinessUnitResponse> update(@PathVariable UUID id,
        ...
        return ApiResponse.success(service.update(id, request), "Business unit updated");
    }
}
